    ...
    <section className="relative w-full bg-fixed bg-center bg-no-repeat bg-cover h-96">
      ...
      <div className="absolute inset-0">
        <div className="flex flex-col items-center justify-center w-full h-full max-w-xl mx-auto">
          ...
          <h2 className="mt-3 text-3xl font-medium tracking-normal text-center text-white sm:text-4xl md:tracking-tight lg:leading-tight lg:text-5xl">post title</h2>
        </div>
      </div>

      <Link href={`/posts/how-important-is-technical-discovery`} className="absolute inset-0">
